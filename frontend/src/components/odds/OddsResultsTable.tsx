...
const OddsResultsTable: React.FC<Props> = ({ fixtures, sortKey, sortDir, onSort, onSelect }) => {
  ...
  if (fixtures.length === 0) {
    return (
      <div className="glass-card rounded-xl p-8 text-center">
        ...
        <p className="text-sm text-gray-500 italic">No fixtures match your current filters. Upload a CSV and adjust the filter settings.</p>
      </div>
    );
  }
